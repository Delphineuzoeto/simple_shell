...
/*
* Command chaining, OR, AND, or, NORM
*/
#define CMD_NORM        0
#define CMD_OR          1
#define CMD_AND         2
...
/*
* convert number TO DIFFERENT CASE
*/
...
/**
* struct liststr - data structure. a singly linked list
...
* allowing for a uniform prototype for a function pointer struct
...
* @status: the return status of the last execution command
